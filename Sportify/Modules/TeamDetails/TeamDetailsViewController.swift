...
class TeamDetailsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        selectedTeam = Team(
                    name:        "London Lions FC",
                    country:     "England",
                    stadium:     "Stamford Bridge",
                    founded:     "1905",
                    about:       "A historic powerhouse in English football...",
    ...
    private func addHeaderView() {
        ...
        headerView.configure(
            teamName:    selectedTeam?.name        ?? "Team Name",
            bannerImage: UIImage(named: selectedTeam?.bannerImage ?? ""),
            logoImage:   UIImage(named: selectedTeam?.logoImage   ?? "")
        )
    ...
    private func addInfoCardsView() {
        ...
        infoCardsView.configure(
            country:  selectedTeam?.country  ?? "N/A",
            stadium:  selectedTeam?.stadium  ?? "N/A",
            founded:  selectedTeam?.founded  ?? "N/A"
        )
    ...
    private func addAboutView() {
        ...
        aboutView.configure(
            description: selectedTeam?.about ?? "No description available."
        )
    ...
    private func addPlayersView() {
        ...
        playersView.configure(players: [
            (name: "John Smith",  image: UIImage(named: "player1")),
            (name: "Emily Jones", image: UIImage(named: "player2")),
            (name: "David Lee",   image: UIImage(named: "player3")),
            (name: "Chris Green", image: UIImage(named: "player4")),
            (name: "Anna White",  image: UIImage(named: "player5"))
        ])
